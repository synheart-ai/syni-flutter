...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/syni-flutter/security/advisories/new).
...
This policy covers the `syni` Flutter SDK published from this repository,
including its on-device inference runtime, agent layer, and bundled persona
assets. Issues in unrelated dependencies should be reported upstream to their
maintainers.
